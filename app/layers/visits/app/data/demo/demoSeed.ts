...
export const demoSeed = {
    ...
    arrivalPlaces: [
        { id: "pl_001", name: "Завод Север-1", address: "г. Санкт-Петербург, Промзона Север, 1", map_x: 430.5, map_y: 310.2 },
        { id: "pl_002", name: "Завод Север-2", address: "г. Санкт-Петербург, Промзона Север, 14", map_x: 1100.1, map_y: 410.6 },
        { id: "pl_003", name: "Завод Восток-1", address: "г. Кудрово, Индустриальная, 7", map_x: 290.0, map_y: 85.0 },
        { id: "pl_004", name: "Завод Восток-2", address: "г. Мурино, Складская, 22", map_x: 710.3, map_y: 220.8 },
        { id: "pl_005", name: "Завод Юг-1", address: "г. Пушкин, Заводская, 3", map_x: 370.7, map_y: 600.4 },
    ],
